              ...
              <>
                <div className="p-5 flex flex-col space-y-4 w-full items-center text-center">
                  ...
                  <div className="w-full flex flex-col gap-2.5 items-center justify-center">
                    {/* Method 1: Popup (Highly recommended for Desktop/PC tabs) */}
                    <button
                      type="button"
                      disabled={isAuthenticating}
                      onClick={async () => {
                        ...
                        try {
                          ...
                          if (err.code === "auth/popup-blocked") {
                            message = "Pop-up login diblokir browser. Izinkan pop-up atau klik Masuk via Redirect di bawah.";
                      ...
                      className="w-full max-w-[280px] h-9.5 flex items-center justify-center gap-2 bg-[#4285F4] hover:bg-[#357ae8] text-white font-sans font-bold rounded-xl transition-all shadow-md active:scale-975 cursor-pointer disabled:opacity-50 text-[11.5px]"
                    >
                      <div className="w-4 h-4 flex items-center justify-center bg-white rounded-full select-none shrink-0 p-0.5">
                    ...
                    {/* Method 2: Redirect (Backup/Secondary option, great for mobile viewport) */}
                    <button
                      type="button"
                      disabled={isAuthenticating}
                      onClick={async () => {
                      ...
                      className="w-full max-w-[280px] h-8.5 flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-850 text-slate-300 hover:text-white font-sans font-semibold border border-slate-800 hover:border-slate-700 rounded-xl transition-all shadow-sm active:scale-975 cursor-pointer disabled:opacity-50 text-[10.5px]"
                    >
                      <div className="w-3.5 h-3.5 flex items-center justify-center select-none shrink-0 opacity-80">
                        <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="currentColor"/>
                        </svg>
                      </div>
                      <span>Masuk dengan Google (Redirect)</span>
                    </button>
